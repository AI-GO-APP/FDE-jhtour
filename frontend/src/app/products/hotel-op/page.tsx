'use client';
/** 訂單 OP 設定 | L_hopemp_set.asp | DB: hotel_op_settings */
import React from 'react';
import { Typography, Card, Form, Input, Switch, InputNumber, Button, message, Divider } from 'antd';
import { SaveOutlined } from '@ant-design/icons';
const { Title } = Typography;
export default function Page() {
  return (<div><Title level={4}>訂單 OP 設定</Title><Card>
    {/* === [API] GET/PUT /api/settings/hotel-op === DB: hotel_op_settings === TODO: [替換] === */}
